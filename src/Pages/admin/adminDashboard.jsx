...
function AdminDashboard() {
  ...
  return (
    <div className='flex h-screen  bg-gradient-to-r from-black via-blue-950 to-purple-950'>
      ...
      <div className={`hidden md:block md:w-64  bg-gradient-to-r from-black via-blue-950 to-purple-950 shadow-md`}>
        <AdminSideNav />
      </div>
      ...
      {isMobile && (
        <>
          ...
          {/* Sidebar */}
          <div 
            className={`fixed inset-y-0 left-0 w-64 bg-black shadow-lg z-30 transform transition-transform duration-300 ease-in-out ${
